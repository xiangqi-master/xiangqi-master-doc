...
### Checkerboard
Below is a demonstration of `Position` class corresponding to the chess board.

<img src="/images/checkerboard.jpg" style={{ borderRadius: '0.5rem' }} />
...
<Frame>
  <img src="/images/checks-passed.png.jpg" style={{ borderRadius: '0.5rem' }} />
</Frame>
